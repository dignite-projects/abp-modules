...
/// <summary>
/// Plays the role of a downstream host's own field-definition entity (e.g. a CMS's <c>Field</c>):
/// its own aggregate, which also implements the kernel's <see cref="IFlexField"/> contract so
/// <c>ConfigureFlexField()</c> can map those columns.
/// </summary>
