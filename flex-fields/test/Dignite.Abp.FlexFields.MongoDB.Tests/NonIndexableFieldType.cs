...
/// <see cref="GetSearchableValues"/> the way <see cref="FieldTypeBase"/>'s own default implementation does.
/// Exists to prove <c>FlexFieldIndexManagerBase.GetIndexableFieldsAsync</c>'s own
/// <c>IndexValueType == null</c> guard is load-bearing rather than redundant: none of the built-in field
/// types can exercise it, since all of them report a non-null <see cref="IndexValueType"/>.
/// </summary>
