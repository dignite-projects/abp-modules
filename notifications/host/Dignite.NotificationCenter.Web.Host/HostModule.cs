...
using Dignite.NotificationCenter.Web.Host.Data;
using Dignite.NotificationCenter.Web.Host.Localization;
using Dignite.NotificationCenter.Web.Host.HealthChecks;
...
using Dignite.NotificationCenter.Web.Host.Notifications;
...
public class HostModule : AbpModule
{
    ...
    private void ConfigureNotificationCenterOutbox()
    {
        ...
        // persisting notification rows and publishing NotificationDeliveryRequestedEto commit together.
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles("/Dignite/NotificationCenter/Web/notification-center.css");
                }
            );
            ...
            options.ScriptBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles("/Dignite/NotificationCenter/Web/notification-center.js");
                    if (hostingEnvironment.IsDevelopment())
                    {
